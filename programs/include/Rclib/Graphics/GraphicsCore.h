...
typedef struct _pixelFormat {
    ...
    _pixelFormat(u8 bytesPerPixel_, u32 rMask_, u32 gMask_, u32 bMask_,
                 u32 aMask_, u8 rShift_, u8 gShift_, u8 bShift_, u8 aShift_,
                 u32 colorkey_, u16 gl_)
    {
...
#define PIXEL_FORMAT_RGBA                                                     \
    PixelFormat(4, 0xff000000, 0x00ff0000, 0x0000ff00, 0x000000ff, 24, 16, 8, \
                0, 0x00000000, GL_RGBA)
#define PIXEL_FORMAT_RGB                                                     \
    PixelFormat(3, 0x00ff0000, 0x0000ff00, 0x000000ff, 0x00000000, 16, 8, 0, \
                0, 0x00000000, GL_RGB)
