...
public:
    ...
    // ベクトル同士の内積
    static void dot(float *dst, const Vector2 &src0, const Vector2 &src1);
    // ベクトル同士の外積
    static void cross(float *dst, const Vector2 &src0, const Vector2 &src1);

    // ベクトルの定数倍
    static void scale(Vector2 *dst, const Vector2 &src0, const float &src1);
