...
#include "Rclib/Graphics/VertexBuffer.h"
...
/*!
  ...
  */
bool VertexBuffer::create(u64 vertexNum, s32 attribNum, s32 atrribSize,
                          void** pVertexArray)
{
    destroy();
    // 頂点バッファオブジェクト
    ...
    // GPU側の頂点領域を確保
    glBufferData(GL_ARRAY_BUFFER, vertexNum * attribNum * atrribSize,
...
void VertexBuffer::bind() { glBindBuffer(GL_ARRAY_BUFFER, bufferObject_); }
