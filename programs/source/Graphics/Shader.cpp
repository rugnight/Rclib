...
// class ShaderObject
/* ------------------------------------------------------- */
ShaderObject::ShaderObject() : type_(0), object_(0) {}
...
GLenum ShaderObject::type() { return type_; }

GLuint ShaderObject::object() { return object_; }
...
void ShaderProgram::begin() { glUseProgram(program_); }
...
void ShaderProgram::setUniformMatrix4fv(u32 location, u32 count,
                                        boolean normalize, f32* value)
{
