...
Vector3::Vector3(float _n) : x(_n), y(_n), z(_n) {}

Vector3::Vector3(float _x, float _y, float _z) : x(_x), y(_y), z(_z) {}

Vector3::Vector3(const Vector3 &src) : x(src.x), y(src.y), z(src.z) {}
...
// ベクトル同士の内積
void Vector3::dot(float *dst, const Vector3 &src0, const Vector3 &src1)
{
...
// ベクトルの定数倍
void Vector3::scale(Vector3 *dst, const Vector3 &src0, const float &src1)
{
    dst->x = src0.x * src1;
    dst->y = src0.y * src1;
    dst->z = src0.z * src1;
